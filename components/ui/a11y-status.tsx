    ...
    >
      ...
      <dl className="mt-3 grid gap-2 sm:grid-cols-2">
        <div data-testid="ux-phase10-keyboard-proof">
          <dt className="font-semibold text-alphavest-subtle">Keyboard actions</dt>
          <dd>Tab reaches controls, Escape closes overlays, Cancel/Back keeps context.</dd>
        </div>
        <div data-testid="ux-phase10-focus-proof">
          <dt className="font-semibold text-alphavest-subtle">Focus return</dt>
        ...
        <div data-testid="ux-phase10-status-proof">
          <dt className="font-semibold text-alphavest-subtle">Status update</dt>
          <dd>{statusAnnouncement}</dd>
        </div>
        <div data-testid="ux-phase10-global-proof">
          <dt className="font-semibold text-alphavest-subtle">Page context</dt>
