  ...
  return (
    ...
    >
      {sections.map((section) => (
        <a
          className={cn(
            "rounded-md border border-alphavest-border/70 bg-alphavest-panel/64 px-3 py-2 text-xs font-semibold text-alphavest-muted transition hover:border-alphavest-gold/60 hover:text-alphavest-ivory",
