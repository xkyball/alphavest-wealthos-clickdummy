...
| `/decisions` | `DecisionsScreenV2` | V2-020, V2-021, V2-022 | Ready, blocked and submitted decision states; Accept/Defer/Reject controls | Advice-like recommendation appears only when release, evidence and permission gates pass. Submission creates visible evidence/audit result. |
