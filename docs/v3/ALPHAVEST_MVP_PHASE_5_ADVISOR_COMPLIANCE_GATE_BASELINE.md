...
| Demo workflow J01 | `j01.approveAdvisor` preserves `clientVisible=false` and says compliance release remains required. | Useful screencast continuity and advisor-not-release proof candidate. |
