...
| MT-007 | Process a signal and route internal work | UF-07 / W-07 / PF-E | Canonical typed boundary (legacy compatibility bridge) for J01 request-data |
| MT-008 | Review an advisor approval package | UF-08 / W-08 / PF-E | Canonical typed boundary (legacy compatibility bridge) for J01 advisor actions |
