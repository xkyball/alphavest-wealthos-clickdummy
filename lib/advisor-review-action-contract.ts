...
export type AdvisorReviewCommand =
  | "REQUEST_ADVISOR_REVIEW_DATA"
  | "ROUTE_TO_ADVISOR_REVIEW"
  | "ESCALATE_ADVISOR_REVIEW_TO_CALL";
...
export const advisorReviewCommandByAction = {
  "j01.requestData": "REQUEST_ADVISOR_REVIEW_DATA",
