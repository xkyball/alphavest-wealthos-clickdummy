...
const guidanceOverrides: Record<string, GuidanceOverride> = {
  ...
  "054": {
    area: "Export",
    gateHint: "Export starts with scope only; redaction, preview, approval, download and share remain separate.",
    nextStep: linkForPageId("055", "Select export scope"),
    primaryAction: linkForPageId("055", "Select export scope"),
    purpose: "Select export scope before redaction, preview, approval and delivery can proceed.",
    relatedRoutes: [linkForPageId("056", "Review redaction"), linkForPageId("057", "Inspect preview")],
    shortTitle: "New export",
  },
  "055": {
    area: "Export",
    gateHint: "Scope selection is not preview or approval. Only permitted objects can move to redaction.",
  ...
  "056": {
    area: "Export",
    gateHint: "Redaction review is not preview approval, download or share.",
    nextStep: linkForPageId("057", "Inspect preview"),
    primaryAction: linkForPageId("057", "Inspect preview"),
    relatedRoutes: [linkForPageId("055", "Review scope"), linkForPageId("058", "Open delivery controls")],
  },
  "057": {
    area: "Export",
