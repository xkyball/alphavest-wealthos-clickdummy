...
function visibleProjectionActionsForProcess(processId: string): ProcessUniverseCaptureAction[] {
  const byProcess: Record<string, ProcessUniverseCaptureAction[]> = {
    ...
    "BP-010": [
      { action: "goto", route: "/entities" },
      visualBefore(processId, "wave_5"),
      { action: "goto", route: "/entities/demo" },
    ...
    "BP-014": [
      ...
      visualBefore(processId, "wave_6"),
      { action: "goto", route: "/tenants/demo/team" },
    ...
    "BP-013": [
      ...
      visualBefore(processId, "wave_7"),
      { action: "goto", route: "/governance/access-requests/demo" },
    ...
    "BP-032": [
      ...
      visualBefore(processId, "wave_7"),
      { action: "goto", route: "/evidence/demo/review" },
    ...
    "BP-082": [
      { action: "goto", route: "/decisions/demo" },
      visualBefore(processId, "wave_7"),
      { action: "goto", route: "/compliance/reviews/demo/audit" },
      { action: "assertText", text: "Audit Timeline" },
      { action: "assertText", text: "Decision status" },
    ...
    "BP-099": [
      { action: "goto", route: "/ops/sla/demo" },
      visualBefore(processId),
    ...
    "BP-015": [
      { action: "goto", route: "/governance/roles/demo?state=base" },
    ...
    "BP-022": [
      { action: "goto", route: "/governance/access-requests/demo?state=base" },
      { action: "click", locator: { kind: "testId", value: "j07-open-access-request-drawer" } },
    ...
    "BP-103": [
      ...
      { action: "assertText", text: "Mutation blocked" },
      visualAfter(processId, ["Mutation blocked"], "wave_2"),
    ],
    "BP-104": [
      ...
      visualBefore(processId, "wave_2"),
      { action: "fill", locator: { kind: "placeholder", value: "Type the exact phrase above" }, value: "DISABLE MFA" },
      { action: "assertText", text: "Exact phrase matched" },
      { action: "click", locator: { kind: "role", role: "button", name: "Confirm change" } },
      { action: "assertText", text: "Mutation blocked" },
      visualAfter(processId, ["Mutation blocked"], "wave_2"),
    ...
    "BP-105": [
      { action: "goto", route: "/admin/tenants" },
      visualBefore(processId, "wave_2"),
      { action: "goto", route: "/tenants/demo/policies" },
    ...
    "BP-050": [
      ...
      { action: "assertText", text: "Advisor decision path" },
      { action: "assertText", text: "Review Recommendation Package" },
      visualAfter(processId, ["Advisor decision path"], "wave_3"),
    ],
    "BP-051": [
      { action: "goto", route: "/advisor/reviews" },
      visualBefore(processId, "wave_3"),
      ...
      { action: "assertText", text: "Review Recommendation Package" },
      { action: "assertText", text: "Recommendation Summary" },
      visualAfter(processId, ["Review Recommendation Package"], "wave_3"),
    ],
    "BP-052": [
      { action: "goto", route: "/advisor/reviews" },
      visualBefore(processId, "wave_3"),
    ...
    "BP-058": [
      ...
      { action: "assertText", text: "Review Requirements" },
    ...
    "BP-034": [
      ...
      { action: "assertText", text: "Operational handoff only" },
      { action: "assertText", text: "Open review work" },
      visualAfter(processId, ["Operational handoff"], "wave_4"),
    ],
    "BP-038": [
      { action: "goto", route: "/advisory" },
      visualBefore(processId, "wave_4"),
      ...
      { action: "assertText", text: "Operational handoff only" },
      { action: "assertText", text: "Client visibility held" },
      visualAfter(processId, ["Operational handoff"], "wave_4"),
    ],
    "BP-039": [
      { action: "goto", route: "/advisory/review-queue" },
      visualBefore(processId, "wave_4"),
      { action: "goto", route: "/advisory/triggers/demo/review" },
    ...
    "BP-042": [
      ...
      { action: "assertText", text: "Release blocked" },
      visualAfter(processId, ["Operational handoff"], "wave_4"),
    ],
    "BP-043": [
      { action: "goto", route: "/advisory" },
    ...
    "BP-047": [
      ...
      { action: "goto", route: "/advisory/review-queue" },
      { action: "assertText", text: "Client visibility held" },
      { action: "assertText", text: "no advice, export, release or client visibility" },
      visualAfter(processId, ["Operational handoff"], "wave_4"),
    ],
    "BP-048": [
      { action: "goto", route: "/advisory" },
