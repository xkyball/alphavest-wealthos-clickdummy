...
function visibleProjectionActionsForProcess(processId: string): ProcessUniverseCaptureAction[] {
  const byProcess: Record<string, ProcessUniverseCaptureAction[]> = {
    ...
    "BP-013": [
      ...
      { action: "assertText", text: "Awaiting approval" },
      { action: "assertText", text: "Review request" },
      visualAfter(processId, ["Awaiting approval"], "wave_7"),
    ],
    "BP-017": [
      { action: "goto", route: "/governance" },
      visualBefore(processId, "wave_6"),
      ...
      { action: "assertText", text: "Awaiting approval" },
      { action: "assertText", text: "Review request" },
      visualAfter(processId, ["Awaiting approval"], "wave_6"),
    ],
    "BP-023": [
      { action: "goto", route: "/documents" },
      visualBefore(processId, "wave_5"),
      { action: "goto", route: "/documents/upload" },
      { action: "assertText", text: "Source file required before upload can start." },
      visualAfter(processId, ["Source file required"], "wave_5"),
    ],
    "BP-025": [
      { action: "goto", route: "/documents/upload" },
    ...
    "BP-088": [
      ...
      visualBefore(processId),
      { action: "goto", route: "/export/client-package/approval" },
      { action: "assertText", text: "Ready for sign-off" },
      { action: "assertText", text: "Record the reviewer decision here" },
      visualAfter(processId, ["sign-off"]),
    ],
    "BP-092": [
      { action: "goto", route: "/export/client-package/approval" },
      visualBefore(processId),
    ...
    "BP-018": [
      ...
      visualAfter(processId, ["Access review", "Available actions"], "wave_2"),
    ],
    "BP-019": [
      { action: "goto", route: "/governance/roles/portfolio-manager?state=base" },
      { action: "click", locator: { kind: "testId", value: "j07-open-role-drawer" } },
    ...
    "BP-050": [
      ...
      { action: "assertText", text: "Review package" },
    ...
    "BP-051": [
      ...
      { action: "assertText", text: "Review package" },
      { action: "assertText", text: "Next action" },
      visualAfter(processId, ["Review package"], "wave_3"),
    ],
    "BP-052": [
      { action: "goto", route: "/advisor/reviews" },
      visualBefore(processId, "wave_3"),
    ...
    "BP-058": [
      ...
      { action: "assertText", text: "Release package status" },
