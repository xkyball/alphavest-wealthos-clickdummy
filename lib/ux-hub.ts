...
export const uxHubDefinitions: Record<string, UxHubDefinition> = {
  ...
  "020": {
    ...
    pageId: "020",
    primaryAction: linkForPageId("019", "Open released portal update", "Continue with the released client-safe projection in the full portal."),
    priorityCards: [
      { detail: "The entry starts from released client-safe projection only.", label: "Released update", tone: "green", value: "Available" },
      { detail: "Draft decisions and internal review detail stay unavailable to clients.", label: "Hidden state", tone: "red", value: "Fail closed" },
      { detail: "The next action opens the full client portal for the same released update.", label: "Next action", tone: "blue", value: "One step" },
    ],
    queue: [
      linkForPageId("019", "Open client portal", "Continue with released client-visible context."),
      linkForPageId("044", "Review released decision", "Inspect the client-safe decision record when released."),
      linkForPageId("058", "Open released export", "Download only after approval and release."),
    ],
    safetyNote: "Client visibility fails closed unless release, redaction and role-safe projection are complete.",
    sourceSummaries: ["Released summary", "Hidden draft state", "Single client action"],
    statusStrip: ["Released only", "Fail closed", "One next action"],
    summary: "The client visibility entry exposes the released projection and one permitted continuation, not a generic mobile action launcher.",
    title: "Client Visibility Entry",
  },
  "024": {
