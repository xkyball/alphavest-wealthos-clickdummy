...
export const uxHubDefinitions: Record<string, UxHubDefinition> = {
  ...
  "038": {
    ...
    priorityCards: [
      ...
      { detail: "Evidence request, block and release are separate gated actions.", label: "Gate split", tone: "gold", value: "Separated" },
      { detail: "Advisor approval does not create client visibility.", label: "Release safety", tone: "red", value: "Blocked" },
    ],
    queue: [
      linkForPageId("040", "Review release gate", "Inspect release prerequisites without skipping evidence."),
    ...
    safetyNote: "Compliance hub can orient release work; it cannot collapse review, block, release, evidence request or audit gates.",
    sourceSummaries: ["Compliance queue", "Evidence readiness", "Audit trail"],
    statusStrip: ["Compliance hub", "Release gated", "Advisor approval != release"],
  ...
  "033": {
    ...
    priorityCards: [
      { detail: "Signals are prioritized before a human opens a scoped review item.", label: "Signal triage", tone: "blue", value: "28" },
    ...
    summary: "The advisory hub chooses the next internal review path instead of mixing signal intake, draft handling and approval gates.",
  ...
  "046": {
    ...
    priorityCards: [
      ...
      { detail: "Pending extraction remains in document review, not release gates.", label: "Extraction queue", tone: "gold", value: "Pending" },
    ...
    safetyNote: "Evidence hub can orient and route, but it cannot claim sufficiency without reviewed, scoped, current and client-safe evidence.",
  ...
  "048": {
    ...
    pageId: "048",
    primaryAction: linkForPageId("050", "Review access request", "Open the scoped access request queue before any permission change."),
    priorityCards: [
      { detail: "Access requests are prioritized before role or policy mutation.", label: "Access queue", tone: "blue", value: "8" },
      { detail: "Role changes require scoped confirmation and audit context.", label: "Role safety", tone: "gold", value: "Bounded" },
      { detail: "Admin navigation never expands payload or release authority.", label: "No bypass", tone: "red", value: "Enforced" },
    ],
    queue: [
      linkForPageId("049", "Review role detail", "Inspect role scope without bypassing policy gates."),
    ...
    sourceSummaries: ["Access requests", "Role scope", "Audit history"],
    statusStrip: ["Governance hub", "Scoped admin", "No bypass"],
  ...
  "052": {
    ...
    priorityCards: [
      ...
      { detail: "Call triggers cannot bypass advisory or compliance gates.", label: "Safety", tone: "red", value: "No bypass" },
    ],
    queue: [
  ...
  "059": {
    ...
    priorityCards: [
      ...
      { detail: "Escalations route work without approving advice or exports.", label: "Escalation", tone: "gold", value: "Scoped" },
      { detail: "Ops cannot bypass compliance, evidence or client visibility gates.", label: "Safety", tone: "red", value: "Blocked" },
    ],
    queue: [
    ...
    statusStrip: ["Ops hub", "Recovery routing", "No gate bypass"],
    summary: "The operations hub directs support teams to the next recovery surface while keeping product and compliance gates intact.",
    title: "Operations Recovery Hub",
  },
  "064": {
    eyebrow: "KYC hub",
    pageId: "064",
    primaryAction: linkForPageId("065", "Open source-of-wealth review", "Inspect source-of-wealth evidence before suitability or IPS gates."),
    priorityCards: [
    ...
    safetyNote: "KYC hub unlocks orientation only; it cannot finalize suitability, IPS, committee or client release gates.",
  ...
  "068": {
    ...
    safetyNote: "Review monitoring is operational proof only; it cannot execute rebalance advice or publish client content.",
    ...
    summary: "The review monitoring hub shows review rhythm and sends users to a scoped monitoring or advisory surface.",
  ...
  "070": {
    ...
    summary: "The committee hub orients high-risk peer review and routes to the decision room without collapsing downstream gates.",
