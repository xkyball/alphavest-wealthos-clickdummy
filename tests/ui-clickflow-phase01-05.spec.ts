...
test.describe("UI Clickflow Phase 01-05 shared guard implementation", () => {
  test("Phase 01 separates route shell, action permission, payload visibility and StatePanel mapping", () => {
  ...
  test("Phase 02 keeps access and foundation pageflows scoped to mapped tenant context", () => {
  ...
  test("Phase 03 models upload and evidence review without upload-to-sufficiency shortcut", () => {
  ...
  test("Phase 04 keeps AI/rules drafts internal and hides them from client projections", () => {
  ...
  test("Phase 05 separates advisor approval from compliance release and audit persistence", () => {
    const advisor = createDemoSession({ roleKey: "senior_wealth_advisor", tenantSlug: "bennett" });
    const compliance = createDemoSession({ roleKey: "compliance_officer", tenantSlug: "bennett" });
